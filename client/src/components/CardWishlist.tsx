...
const CardWishlist: React.FunctionComponent<CardProps> = ({
  product,
  fetchProducts,
}) => {
  ...
  return (
    <div
      key={product.slug}
      className=" relative bg-gray-200 hover:bg-red-100 flex flex-col border-solid border-2 shadow-md"
    >
      ...
      <div className="flex justify-between items-center ">
        ...
        <Remove productId={product._id} fetchProducts={fetchProducts} />
      </div>
    </div>
  );
};
